...
def handle_upload(bucket_name, file_name, db, verbose=False):
    ...
    if verbose: logger.log(f"File: {file_name}")
    ...
    if verbose: logger.log(f"User Name: {user_name}")
    ...
    # if verbose: logger.log(f"user_data: ", user_data)
